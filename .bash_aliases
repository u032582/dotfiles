...
alias ssm="aws ssm describe-instance-information --query 'InstanceInformationList[*].{InstanceId:InstanceId, Platform:PlatformName,IPAddress:IPAddress,Name:InstanceName,version:PlatformVersion}' --output table"
